...
print "  -------------------------------------------------------------------------"    
for i in range(4):
    print "    ( % 5.1f, % 5.1f)   ( % 5.1f, % 5.1f)   ( % 5.1f, % 5.1f)   ( % 5.1f, % 5.1f)"%(adu_rms[i*8],adu_rms[1+i*8],adu_rms[2+i*8],adu_rms[3+i*8],adu_rms[4+i*8],adu_rms[5+i*8],adu_rms[6+i*8],adu_rms[7+i*8])
print
